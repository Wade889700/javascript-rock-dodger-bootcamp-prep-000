...
function checkCollision(rock) {
  ...
  if (top > 360) {
    ...
    const dodgerRightEdge = dodgerLeftEdge + 40; // FIXME: The DODGER is 40 pixels wide -- how do we get the right edge?
    const rockLeftEdge = positionToInteger(rock.style.left)
    const rockRightEdge = rockLeftEdge + 20;  // FIXME: The rock is 20 pixel's wide -- how do we get the right edge?
    
    return((rockLeftEdge < dodgerLeftEdge && rockRightEdge > rockLeftEdge)||
...
function createRock(x) {
  ...
  GAME.append(rock); /* Now that we have a rock, we'll need to append it to GAME and move it downwards.*/
